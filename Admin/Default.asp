...
<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
	<tr bgcolor="#6A6A6A" height="26">
		<td colspan="3"><b><font color="#FFFFFF">&nbsp;管理员账号管理</font></b></td>
	</tr>  
	<tr height="20">
    <td width="*" bgcolor="#999999"><font color="#FFFFFF">&nbsp;管理员ID</font></td>
    <td width="1" bgcolor="#999999" ><font color="#FFFFFF">&nbsp;<nobr>管理员密码</nobr></font></td>
	...
	<%
	  ...
	  ThisPage							= Request.ServerVariables("PATH_INFO")
		...
		Dim i, TrBgColor
		'-------------------0-----------1-------------2
		Sql = "Select [Admin_ID], [Admin_Name], [Admin_Password] From [Monolith_Admin] Order By [Admin_ID] Desc "
  ...
  <tr  <%=TrBgColor%> height="22">
    <td>&nbsp;<%=Rs(1)%></td>
    <td>&nbsp;<%=Rs(2)%></td>
    <td>｜<a href="Edit.asp?Admin_ID=<%=Rs(0)%>&Page=<%=Page%>">修改</a>｜<a href="Del.asp?Admin_ID=<%=Rs(0)%>&Page=<%=Page%>">删除</a>｜</td>
  </tr>
	<%
    Rs.MoveNext
