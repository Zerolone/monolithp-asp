...
<%  if request("method")="new" then %>
    ...
    <table width=95% cellspacing=0 align=center bgcolor="#3399CC" class="clblack" cellpadding="0" border="1" bordercolorlight="#000000" bordercolordark="#FFFFFF">
...
%> 
	...
	if j=0 then %> 
      <tr bgcolor='#eeeffe'> <%if session("ListMethod")=1 and method<>"new" then %> 
        <td bgcolor="#3399CC" class="black2">&nbsp;</td>
        <%end if%> 
        <td bgcolor="#3399CC" class="black2"> 
          <center>
