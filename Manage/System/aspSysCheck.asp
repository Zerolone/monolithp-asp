...
var CCNS_program="COCOON ASP 探针";var CCNS_version="2.9.00";document.title=CCNS_program+" v"+ CCNS_version+"<%=' on '+ sServerName.toUpperCase()+ '  [ '+ sServerAddr+ ' ]'%>";</script><body><a name="top"></a><table width="750" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<table border="0" cellpadding="0" cellspacing="0" style="width:480;height:60;border:solid 1px black;text-align:left;padding-left:10pt">
			<tr>
				<td height="56"><span id="divCcAd" name="divCcAd" style>* 欢迎使用COCOON探针，本程序公开源代码，你可以任意复制、传播和使用。<br>
&nbsp; 你可以从我们的网站 ( <a href="http:," www.ccopus.com">www.ccopus.com</a>) 或其他支持站点下载到本程序。</span></td>
			</tr>
		</table>
		</td>
	</tr>
...
<table width="750" border="0" cellspacing="0" cellpadding="0" style="width:750;border:0px solid black;padding:3px;padding-right:0px">
	<tr>
		<td align="left"><nobr>〖服务器〗<a href="#ServerInfo" onclick="javascript:showInfo(0);">&#9674; 
		基本信息</a> <a href="#ServerComponent" onclick="javascript:showInfo(0);">&#9674; 
		组件信息</a> <a href="#ArithmeticTest" onclick="javascript:showInfo(0);">&#9674; 运算能力</a>
		...
		<font color="#DD5B14">&#9830; 数据库驱动</font></a> -〖客户端〗<a href="#ClientInfo" onclick="javascript:showInfo(1);">&#9674; 
		基本信息</a> <a href="#ClientComponent" onclick="javascript:showInfo(1);">&#9674; 
		组件信息</a>
	...
	<table width="750" border="0" cellpadding="3" cellspacing="1" class="tbl1">
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="3" cellspacing="1" class="tbl1o1">
				...
				<tr>
					<td width="130" class="td1o1">&nbsp;域名<br>
				...
				<tr>
					<td width="130" class="td1o1">&nbsp;服务器端口<br>
					<font color="#666666">&nbsp;Server Port</font></td>
					<td width="240" class="td1o2">&nbsp;<%=Request.ServerVariables("SERVER_PORT")%></td>
					<td width="130" class="td1o1">&nbsp;脚本超时时间<br>
					<font color="#666666">&nbsp;Script Timeout</font></td>
					<td width="240" class="td1o2">&nbsp;<%=iServerTimeout%>秒</td>
				</tr>
				<tr>
					<td width="130" class="td1o1">&nbsp;信息服务软件<br>
					<font color="#666666">&nbsp;Server Software</font></td>
					<td width="240" class="td1o2">&nbsp;<%=Request.ServerVariables("SERVER_SOFTWARE")%></td>
					<td width="130" nowrap class="td1o1">&nbsp;CPU数量<br>
					<font color="#666666">&nbsp;Number of Processors</font></td>
					<td width="240" class="td1o2">&nbsp;<%=isNaN(sNumberOfCpu)?' [未知]':sNumberOfCpu+' 个'%></td>
				</tr>
				<tr>
					<td width="130" class="td1o1">&nbsp;服务器操作系统<br>
					<font color="#666666">&nbsp;Operating System</font></td>
					<td width="240" class="td1o2">&nbsp;<%=sOsInfo%></td>
					<td width="130" class="td1o1">&nbsp;系统文件夹<br>
					<font color="#666666">&nbsp;System Path</font></td>
					<td width="240" class="td1o2"><%if(sOsInfo.indexOf("Window")>-1) Response.Write(" &nbsp;"+Request.ServerVariables("windir")+'');else Response.Write(" &nbsp; [未知]");%></td>
				</tr>
				<tr>
					<td width="130" nowrap class="td1o1">&nbsp;服务器变量数<br>
					<font color="#666666">&nbsp;Application Count</font></td>
					<td width="240" nowrap class="td1o2">&nbsp;<%=Application.Contents.Count%>个 
					[<a href="<%=sUrl%>?Application#Application" class="td102a">遍历Application变量</a>]
					</td>
					<td nowrap class="td1o1">&nbsp;会话变量数<br>
					<font color="#666666">&nbsp;Session Count</font></td>
					<td width="240" class="td1o2">&nbsp;<%=Session.Contents.Count%>个 
					<span class="td1o21">[<a href="<%=sUrl%>?Session#Session" class="td102a">遍历Session变量</a>]
					</span></td>
				</tr>
				<tr>
					<td width="130" class="td1o1">&nbsp;物理路径<br>
...
&nbsp;Path:<%=Request.ServerVariables("PATH_TRANSLATED")%></td>
				...
				<tr>
					<td width="130" class="td1o1">&nbsp;脚本引擎<br>
				...
				<tr>
					<td width="130" class="td1o1">&nbsp;当前时间<br>
					<font color="#666666">&nbsp;Current Time</font></td>
					<td colspan="3" class="td1o2">&nbsp;服务器:<%=new Date()%><br>
&nbsp;客户端:<script language="JavaScript">document.write(new Date())</script></td>
				</tr>
			</table>
			</td>
		</tr>
	...
	<table width="750" border="0" cellpadding="3" cellspacing="1" class="tbl1">
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td><font color="#FFFFFF" face="webdings">8</font>
					<font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif">
					<strong>遍历服务器Application变量 [共 <%=Application.Contents.Count%>个]<script>
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="3" cellspacing="1" class="tbl1o1">
				<tr>
					<td width="35%" class="td1"><font color="#5C72BA">&nbsp;变量</font></td>
				...
				<%}if(!iCount){%><tr>
					<td align="left" valign="top" class="td1o21" colspan="2">没有Application变量</td>
				</tr>
				<%}%></table>
			</td>
		</tr>
	...
	<table width="750" border="0" cellpadding="3" cellspacing="1" class="tbl1">
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td><font color="#FFFFFF" face="webdings">8</font>
					<font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif">
					<strong>遍历服务器Session变量 [共 <%=Session.Contents.Count%>个]<script>
					showTools();</script>:::...</strong></font></td>
					<td align="right"><font color="#D2D8EC">Coding by Sunrise_Chen.
					</font></td>
				</tr>
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="3" cellspacing="1" class="tbl1o1">
				<tr>
					<td width="30%" class="td1"><font color="#5C72BA">&nbsp;变量</font></td>
				...
				<%}if(!iCount){%><tr>
					<td align="left" valign="top" class="td1o21" colspan="2">没有Session变量</td>
				</tr>
				<%}%></table>
			</td>
		</tr>
	...
	<div id="divDriverInfoLoading">
		...
		-</font>正在读取服务器磁盘信息，可能会花费一些时间，请耐心等待...<script language="JavaScript">showLoadingAnimation('divDriverInfoLoadingAction')</script></div>
	<% Response.Flush() %><a name="DriverInfo"></a><table width="750" border="0" cellpadding="3" cellspacing="1" class="tbl1">
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="3" cellspacing="1" class="tbl1o1">
				...
				<%function getStrType(s){switch(s){case 0:return "Unknown";case 1:return "3.5 软盘";case 2:return "本地硬盘";case 3:return "Network";case 4:return "CD 驱动器";case 5:return "RamDisk";}}function getSize(iBytes){if(iBytes<1024) return iBytes+' bytes';else if(iBytes/1024<1024) return Math.round(iBytes/1024*100)/100+ ' KB';else if(iBytes/1024/1024<1024) return Math.round(iBytes/1024/1024*100)/100+ ' MB';else return Math.round(iBytes/1024/1024/1024*100)/100+ ' GB';}var bFso=true;try{var oFso=Server.CreateObject("Scripting.FileSystemObject");%><tr>
					<td align="left" valign="top" class="td1o2"><%try{var sCurrPath=Server.MapPath(".");var oFolder=oFso.GetFolder(sCurrPath);var sOut="<div>当前文件夹："+sCurrPath+"</div>"+"<div>子文件夹数："+oFolder.SubFolders.Count+"　文件数："+oFolder.Files.Count+"</div>"+"<div>大小："+getSize(oFolder.Size)+"</div>";Response.Write(sOut);}catch(e){Response.Write(e.description);}%></td>
					<td valign="top" class="td1o2" style="padding:7px;">
					<table width="100%" border="0" cellspacing="1" cellpadding="0">
						<%try{var oDrivers=oFso.Drives;var sOut="<tr align='right' bgColor='#dddddd'>"+"<td style='text-align:center'>磁盘</td>"+"<td style='width:100px'>类型&nbsp;</td>"+"<td style='width:100px'>文件系统&nbsp;</td>"+"<td style='width:100px;'>可用空间&nbsp;</td>"+"<td style='width:100px;'>总容量&nbsp;</td>"+"</tr>";Response.Write(sOut);for(var x=new Enumerator(oDrivers);!x.atEnd();x.moveNext()) {var oDriver=x.item();var sOut="<tr align='right'>"+"<td align='center'>"+oDriver.Path+"</td>"+"<td>"+getStrType(oDriver.DriveType)+"&nbsp;</td>"+"<td>"+(oDriver.isReady?oDriver.FileSystem:'N/A')+"&nbsp;</td>"+"<td>"+(oDriver.isReady?getSize(oDriver.AvailableSpace):'N/A')+"&nbsp;</td>"+"<td>"+(oDriver.isReady?getSize(oDriver.TotalSize):'N/A')+"&nbsp;</td>"+"</tr>";Response.Write(sOut);}}catch(e){Response.Write(e.description);}%></table>
					</td>
				</tr>
				<%}catch(e){Response.Write("<tr><td colspan=2 class=td1o2>（！） 此操作需要服务器支持FileSystemObject，而您的服务器不支持该组件，详见“服务器组件信息”。</span></tr>")}%></table>
			</td>
		</tr>
		<tr>
			<td height="5" class="tr1"></td>
	...
	<table width="750" border="0" cellpadding="3" cellspacing="1" class="tbl1">
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="3" cellspacing="1" class="tbl1o1">
				<tr>
					<td width="80%" class="td1">&nbsp;组件名</td>
					<td width="10%" align="center" class="td1">支持</td>
					<td width="10%" align="center" class="td1">版本</td>
				</tr>
				<%var iIndex, sObjName, sObjDetail, sObjType, iIndexCount, bShowUnSupport;var sObjVersion,bObjInstalled;iIndex=0;iIndexCount=-1;bShowUnSupport=false;for(var i=0;;i++){if(i>=arrObj.length||iIndex!=arrObj [i][2]){if(iIndexCount==0&&iIndex<99){Response.Write('<tr>'+'<td width="80%" class="td1o1" style="color:#666666" colspan="3">&nbsp;<i>( 服务器暂不支持该类组件 )</i></td>'+'</tr>');}if(i>=arrObj.length) break;iIndex=arrObj [i][2];iIndexCount=0;switch(iIndex){case 1:sObjType="IIS自带组件";break;case 2:sObjType="常见的第三方文件上传和管理组件";break;case 3:sObjType="常见的第三方文件邮件发送组件";break;case 4:sObjType="常见的图像处理组件";break;default:sObjType="自定义组件";break;}Response.Write('<tr>'+'<td colspan="3" bgcolor="#D6DBED">&nbsp;■<b>'+sObjType+'</b></td>'+'</tr>');} sObjName=arrObj [i][0];sObjDetail=arrObj [i][1];bObjInstalled=true;sObjVersion=getObjVer(sObjName);if(sObjVersion=="N/A"){bObjInstalled=false;sObjVersion="";}if(bObjInstalled||iIndex==99){iIndexCount++;Response.Write('<tr>'+'<td width="80%" class="td1o1">'+' &nbsp;'+ sObjName+ (sObjDetail?' <font color="#666666">( '+ sObjDetail+ ' )</font>':'')+ ''+'</td>'+'<td width="10%" align="center" class="td1o2">'+ (bObjInstalled?"√":"×")+ '</td>'+'<td width="10%" align="center" class="td1o2"><span style="width:100%;height:18;overflow-y:auto;">'+ sObjVersion+ '</span></td>'+'</tr>');}} %><tr>
					<form method="post" action="<%=sTheFile%>">
						<td colspan="3" bgcolor="#D6DBED">&nbsp;检测其他组件 
						<input name="sObjName" type="text" class="tbl1" id="sObjName" style="background-color:#F3F4FA;width:400px"><input name="Submit" type="submit" value="提交" style="border:1px;background-color:#336699;color:#d2d8ec;padding-top:1px;width:70px"></td>
					</form>
				</tr>
			</table>
			</td>
	...
	<div id="divDriverInfoLoading">
		<font face="Courier New" id="divDriverInfoLoadingAction" style="width:5px;">
		-</font>正在读取服务器驱动程序信息，可能会花费一些时间，请耐心等待...<script language="JavaScript">showLoadingAnimation('divDriverInfoLoadingAction')</script></div>
	<% Response.Flush() %><a name="DatabaseDriver"></a><table width="750" border="0" cellpadding="3" cellspacing="1" class="tbl1">
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="3" cellspacing="1" class="tbl1o1">
				<tr>
					<td width="35%" class="td1"><font color="#5C72BA">&nbsp;驱动程序名</font></td>
					<td width="5%" class="td1" align="center">&nbsp;支持</td>
					<td width="35%" class="td1"><font color="#5C72BA">&nbsp;驱动程序名</font></td>
					<td width="5%" class="td1" align="center">&nbsp;支持</td>
				</tr>
	...
	<script language="JavaScript">document.getElementById('divDriverInfoLoading').style.display='none';</script>
	<%}%><%Server.ScriptTimeout=360;var bTest, tTimeBegin, tTimeEnd, iResultTime1,iResultTime2,sResultTime1,sResultTime2, i;tTimeBegin=new Date();for(i=0;i<500000;++i);tTimeEnd=new Date();iResultTime1=(tTimeEnd - tTimeBegin) / 1000;sResultTime1=iResultTime1+" 秒.  ≈"+((Math.round(500000/iResultTime1*100))/100)+" 次/秒.";tTimeBegin=new Date();for(i=0;i<200000;++i) Math.sqrt(2);tTimeEnd=new Date();iResultTime2=(tTimeEnd - tTimeBegin) / 1000;sResultTime2=iResultTime2+" 秒.  ≈"+ ((Math.round(200000/iResultTime2*100))/100)+" 次/秒."%><br>
	...
	<table width="750" border="0" cellpadding="3" cellspacing="1" class="tbl1">
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<span style="cursor:hand" title="描述:50万次叠加运算并赋值">50万次&quot;加法&quot;运算</span>&amp;<span style="cursor:hand" title="描述:20万次叠加,赋值以及20万次2的2次方根运算">20万次&quot;开方&quot;运算</span>)
					</font>
					<font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif">
					<strong>
					<script>showTools();</script>
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="3" cellspacing="1" class="tbl1o1">
				...
				<tr>
					<td class="td1o1">&nbsp;<a href="http://www.senye.net/">胜易网络主机<em><font color="#666666">(Senye.net)</font></em></a> 
					[ 2003/11/5 16:05 ]</td>
					<td align="center" class="td1o2">0.219 秒. ≈2283105.0 次/秒.</td>
					<td align="center" class="td1o2">0.265 秒. ≈754716.98 次/秒.</td>
				</tr>
				<tr>
					<td class="td1o1" style="color:#336699;font-weight:normal;">&nbsp;当前服务器 
					<%=Request.ServerVariables("SERVER_NAME")%></td>
					<td align="center" class="td1o2">
					<a href="<%=sTheFile+'?'+Math.random()%>#ArithmeticTest" title="重新测试" onfocus="this.blur();" style="color:#336699">
					<%=sResultTime1%></a></td>
					<td align="center" class="td1o2">
					<a href="<%=sTheFile+'?'+Math.random()%>#ArithmeticTest" title="重新测试" onfocus="this.blur();" style="color:#336699">
					<%=sResultTime2%></a></td>
...
&nbsp;</td>
					<td class="td1o1">&nbsp;<a href="<%=sTheFile+'?'+Math.random()%>&SpeedTest#SpeedTest" title="测试连接速度" onfocus="this.blur();" style="color:#5c72ba"><u><script language="JavaScript">
					if(bSpeedTest=='true'){document.write(Math.round(iKbps/8*100)/100+ ' k/s');}else{document.write("开始测试");}</script></u></a></td>
				</tr>
			</table>
			</td>
		</tr>
			...
			<table width="100%" border="0" cellpadding="3" cellspacing="1" class="tbl2o1" id="tblClientComponent">
				...
				<tr>
					<form method="post" onsubmit="checkPlug(this.clientObj [0].value,this.clientObj [1].value,2);return false;">
						<td colspan="2" class="td2o1">&nbsp;检测其他组件： 组件名(Netscape必填)
						...
						<input style="BORDER-RIGHT:1px;BORDER-TOP:1px;BORDER-LEFT:1px;COLOR:#FFF;BORDER-BOTTOM:1px;BACKGROUND-COLOR:#50A0A0;width:70px;padding-top:1px" type="submit" value="提交" name="Submit"></td>
					</form>
				</tr>
			</table>
			</td>
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td><font color="#FFFFFF" face="webdings">8</font>
					<font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif">
					<strong>客户端运算能力</strong>（500万次 <strong>纯加法</strong>运算 ）<strong><script>
					showTools();</script>:::...</strong></font></td>
					<td align="right"><font color="#FFFAF7">Coding by Sunrise_Chen.
					</font></td>
				</tr>
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="3" cellspacing="1" class="tbl2o1">
				...
				<tr>
					...
					<a href="javascript:void(0);" onclick="runTest(this)" onfocus="this.blur();" title="测试当前客户端">
					开始测试</a></u></td>
				</tr>
			</table>
			</td>
...
<%="<div id='chkAspSupport'></div>"%><script language="JavaScript">pageInit();</script><div align="center" style="width:750px">
	<hr size="1"><a href="http://www.ccopus.com" target="_blank">COCOON sTudio 版权所有</a>。<a href="http://www.ccopus.com/code/aspSysCheck.asp"> 
	[点这里下载或更新本探针]</a><% tPageEndTime=new Date();%><%="<br>页面执行时间：约 <font color='#990000'><b>"+((tPageEndTime-tPageStartTime)/1000)+"</b></font>秒"%><script langauge="JavaScript" src="http://www.ccopus.com/_js/count_aspcheck.js"></script></div>
