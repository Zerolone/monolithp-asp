...
<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
	<tr bgcolor="#6A6A6A" height="26">
		<td colspan="3"><b><font color="#FFFFFF">&nbsp;信息发布系统设置 &gt;&gt; 信息来源</font></b><font color="#FFFFFF"><b>管理 
		&gt;&gt; 信息来源察看</b></font></td>
	</tr>
	<tr height="20" bgcolor="#FFFFFF">
		<td width="71%" bgcolor="#999999"><font color="#FFFFFF">&nbsp;来源</font></td>
	...
	<%
	  ...
	  ThisPage							= Request.ServerVariables("PATH_INFO")
		...
		Dim TrBgColor
		'--------------------0------------1--------------2
		Sql = "Select [From_ID], [From_Name], [From_Order] From [Monolith_Info_From] Order By [From_Order] Asc"
	...
	<tr <%=trbgcolor%>>
		...
		<td>｜<a href="From_Edit.asp?From_ID=<%=Rs(0)%>" target="tabWin" onclick="fnClick();">修改</a>｜<a href="From_Del.asp?From_ID=<%=Rs(0)%>&Page=<%=Page%>">删除</a>｜</td>
	</tr>
	<%
			Rs.MoveNext
