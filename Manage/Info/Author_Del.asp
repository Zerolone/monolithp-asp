...
%>
<form name="form1" method="post" action="Author_Del_Submit.asp">
	<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
		<tr bgcolor="#6A6A6A" height="26">
			<td colspan="2"><b><font color="#FFFFFF">&nbsp;信息发布系统设置 &gt;&gt; 信息作者</font></b><font color="#FFFFFF"><b>管理 
			&gt;&gt; 信息作者</b></font><b><font color="#FFFFFF">删除</font></b></td>
		</tr>
		<tr>
