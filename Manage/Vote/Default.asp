...
<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
	<tr bgcolor="#6A6A6A" height="26">
		<td colspan="3"><b><font color="#FFFFFF">&nbsp;调查管理</font></b></td>
	</tr>  
	<tr height="20">
    <td bgcolor="#999999"><font color="#FFFFFF">&nbsp;调查标题</font></td>
    <td bgcolor="#999999"><font color="#FFFFFF">&nbsp;是否启用</font></td>
    <td width="100" bgcolor="#999999"><font color="#FFFFFF">&nbsp;操作</font></td>
  </tr>
	<%
  ...
  <tr  <%=TrBgColor%> height="22">
    <td>&nbsp;<%=Rs(1)%></td>
    <td>&nbsp;<%=Rs(2)%></td>
    <td>｜<a href="Edit.asp?Vote_ID=<%=Rs(0)%>&Page=<%=Page%>">修改</a>｜<a href="Del.asp?Vote_ID=<%=Rs(0)%>&Page=<%=Page%>">删除</a>｜</td>
  </tr>
	<%
    Rs.MoveNext
