...
<form name="form1" method="post" action="<%=ThisPage%>?Code=Edit">
	<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
		<tr bgcolor="#6A6A6A" height="26">
			<td colspan="3"><b><font color="#FFFFFF">&nbsp;调查管理 &gt;&gt; 修改调查项目</font></b></td>
		</tr>
		<tr>
			<td width="100" height="20" bgcolor="#999999" align="right">
			<font color="#FFFFFF">标&nbsp;&nbsp;&nbsp; 题：</font></td>
			<td bgcolor="#FFFFFF">
			<input name="Vote_Title" type="text" id="Vote_Title" value="<%=Trim(Rs(0))%>" size="40" class="InputBox">
			</td>
		</tr>
		<tr>
			...
			<td bgcolor="#FFFFFF">
			<input name="Vote_Answer1" type="text" id="Vote_Hits" value="<%=Rs(1)%>" size="40" class="InputBox">
		...
		<tr>
			...
			<td bgcolor="#FFFFFF">
			<input name="Vote_Answer2" type="text" id="Vote_Hits" value="<%=Rs(2)%>" size="40" class="InputBox">
		...
		<tr>
			...
			<td bgcolor="#FFFFFF">
			<input name="Vote_Answer3" type="text" id="Vote_Hits" value="<%=Rs(3)%>" size="40" class="InputBox">
		...
		<tr>
			...
			<td bgcolor="#FFFFFF">
			<input name="Vote_Answer4" type="text" id="Vote_Hits" value="<%=Rs(4)%>" size="40" class="InputBox">
		...
		<tr>
			...
			<td bgcolor="#FFFFFF">
			<input name="Vote_Answer5" type="text" id="Vote_Hits" value="<%=Rs(5)%>" size="40" class="InputBox">
		...
		<tr>
			...
			<td bgcolor="#FFFFFF">
			<input name="Vote_Answer6" type="text" id="Vote_Hits" value="<%=Rs(6)%>" size="40" class="InputBox">
		...
		<tr>
			...
			<td bgcolor="#FFFFFF">
			<input name="Vote_Answer7" type="text" id="Vote_Hits" value="<%=Rs(7)%>" size="40" class="InputBox">
		...
		<tr>
			...
			<td bgcolor="#FFFFFF">
			<input name="Vote_Answer8" type="text" id="Vote_Hits" value="<%=Rs(8)%>" size="40" class="InputBox">
		...
		<tr>
			...
			<td bgcolor="#FFFFFF">
			<input name="Vote_Active" type="radio" value="0" id="Vote_Active_0" <% if Not rs(17) then response.write "checked" %>><label for="Vote_Active_0">不使用</label>
			<input type="radio" name="Vote_Active" value="1" id="Vote_Active_1" <% if rs(17) then response.write "checked" %>><label for="Vote_Active_1">使用</label>
			</td>
		</tr>
		<tr>
			<td bgcolor="#999999" width="100" height="20">　</td>
			<td colspan="2" bgcolor="#FFFFFF">
			<input type="submit" name="Submit" value=" 修 改 调 查 项 目 " class="InputBox"> <input type="button" name="Submit2" value=" 返 回 " onClick="window.open('Default.asp', '_self');" class="InputBox">
