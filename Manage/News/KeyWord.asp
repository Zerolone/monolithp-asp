...
<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
	<tr bgcolor="#6A6A6A" height="26">
		<td colspan="3"><b><font color="#FFFFFF">&nbsp;新闻系统设置 &gt;&gt; 新闻关键字</font></b><font color="#FFFFFF"><b>管理 
		&gt;&gt; 新闻关键字察看</b></font></td>
	</tr>
	<tr height="20" bgcolor="#FFFFFF">
		<td width="71%" bgcolor="#999999"><font color="#FFFFFF">&nbsp;关键字名称</font></td>
	...
	<%
	  ...
	  ThisPage							= Request.ServerVariables("PATH_INFO")
		...
		Dim TrBgColor
		'--------------------0------------1--------------2
		Sql = "Select [KeyWord_ID], [KeyWord_Name], [KeyWord_Order] From [Monolith_News_KeyWord] Order By [KeyWord_Order] Asc"
	...
	<tr <%=trbgcolor%>>
		...
		<td>｜<a href="KeyWord_Edit.asp?KeyWord_ID=<%=Rs(0)%>" target="tabWin" onclick="fnClick();">修改</a>｜<a href="KeyWord_Del.asp?KeyWord_ID=<%=Rs(0)%>&Page=<%=Page%>">删除</a>｜</td>
	</tr>
	<%
			Rs.MoveNext
