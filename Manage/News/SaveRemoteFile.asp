...
'------------------------------------
		TheString = "parent.frames.Monolith_News_Body.document.body.innerHTML=parent.frames.Monolith_News_Body.document.body.innerHTML.replace('" & News_Content_Arr(i) & "','" & UrlPath & GetFileName(News_Content_Arr(i)) & "');" & TheString
	Next
