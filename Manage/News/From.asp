...
<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
	<tr bgcolor="#6A6A6A" height="26">
		<td colspan="3"><b><font color="#FFFFFF">&nbsp;新闻系统设置 &gt;&gt; 新闻来源</font></b><font color="#FFFFFF"><b>管理 
		&gt;&gt; 新闻来源察看</b></font></td>
	</tr>
	...
	<%
	  ...
	  ThisPage							= Request.ServerVariables("PATH_INFO")
		...
		Dim TrBgColor
		'--------------------0------------1--------------2
		Sql = "Select [From_ID], [From_Name], [From_Order] From [Monolith_News_From] Order By [From_Order] Asc"
