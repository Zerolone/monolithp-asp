...
<%
	...
	Sql = "Select [KeyWord_Name], [KeyWord_Order] From [Monolith_News_KeyWord] Where [KeyWord_ID]=" & KeyWord_ID
...
%>
<form name="form1" method="post" action="../News/KeyWord_Del_Submit.asp">
	<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
		<tr bgcolor="#6A6A6A" height="26">
			<td colspan="2"><b><font color="#FFFFFF">&nbsp;新闻系统设置 &gt;&gt; 新闻关键字</font></b><font color="#FFFFFF"><b>管理 
			&gt;&gt; 新闻关键字</b></font><b><font color="#FFFFFF">删除</font></b></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<input type="reset" value=" 返 回 (Alt + N) " name="B2" class="InputBox" accesskey="N" onclick="window.open('KeyWord.asp?Page=<%=Page%>','_self');">
			</td>
		</tr>
	</table>
</form>
