...
%>
<form name="form1" method="post" action="../News/From_Del_Submit.asp">
	<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
		<tr bgcolor="#6A6A6A" height="26">
			<td colspan="2"><b><font color="#FFFFFF">&nbsp;新闻系统设置 &gt;&gt; 新闻
			来源</font></b><font color="#FFFFFF"><b>管理 &gt;&gt; 新闻来源</b></font><b><font color="#FFFFFF">删除</font></b></td>
		</tr>
		<tr>
