...
<%
	...
	Sql = "Select [Author_Name], [Author_Order] From [Monolith_News_Author] Where [Author_ID]=" & Author_ID
...
%>
<form name="form1" method="post" action="../News/Author_Del_Submit.asp">
	<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
		<tr bgcolor="#6A6A6A" height="26">
			<td colspan="2"><b><font color="#FFFFFF">&nbsp;新闻系统设置 &gt;&gt; 新闻作者</font></b><font color="#FFFFFF"><b>管理 
			&gt;&gt; 新闻作者</b></font><b><font color="#FFFFFF">删除</font></b></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<input type="reset" value=" 返 回 (Alt + N) " name="B2" class="InputBox" accesskey="N" onclick="window.open('Author.asp?Page=<%=Page%>','_self');">
			</td>
		</tr>
	</table>
</form>
