...
//	     str+='文件'+i+':<input type="file" name="file'+i+'" style="width:350" class="InputBox" style="width=350"><br><br>';
	  ...
	  window.upid.innerHTML=str+'<br>';
					...
					&nbsp;&nbsp;需要上传的个数 <input type="text" name="upcount" value="<%=NewsSettingArr(1)%>" class="InputBox" style="width=100"> 
					<input type="button" name="Button" onclick="setid();" value=" 设 定 (Alt + S) " class="InputBox" accesskey="S"> </li>
					<br>
					&nbsp;&nbsp;上传到:<input type="text" name="filepath" value="<%=NewsSettingArr(0)%>" class="InputBox" style="width=400">
					</td>
				</tr>
				<tr align="center">
