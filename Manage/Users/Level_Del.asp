...
<form name="form1" method="post" action="Level_Del_Submit.asp">
	<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
		<tr bgcolor="#6A6A6A" height="26">
			<td colspan="2"><b><font color="#FFFFFF">&nbsp;会员设置 &gt;&gt; 会员等级删除</font></b></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<input type="reset" value=" 返 回 (Alt + N) " name="B2" class="InputBox" accesskey="N" onclick="window.open('Level.asp?Page=<%=Page%>','_self');">
			</td>
		</tr>
	</table>
</form>
