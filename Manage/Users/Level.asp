...
<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
	<tr bgcolor="#6A6A6A" height="26">
		<td colspan="4"><b><font color="#FFFFFF">&nbsp;会员设置 &gt;&gt; 会员等级察看</font></b></td>
	</tr>  
	<tr height="20">
    <td bgcolor="#999999"><font color="#FFFFFF">&nbsp;会员等级</font></td>
    <td width="1" bgcolor="#999999"><font color="#FFFFFF"><nobr>&nbsp;会员等级</nobr></font></td>
    <td width="1" bgcolor="#999999"><font color="#FFFFFF"><nobr>&nbsp;会员顺序</nobr></font></td>
	...
	<%
	  ...
	  ThisPage							= Request.ServerVariables("PATH_INFO")
		...
		Dim i, TrBgColor
		'-------------------0-----------1-------------2
		Sql = "Select [Level_ID], [Level_Name], [Level_Order] From [Monolith_Users_Level] Order By [Level_Order] Asc"
		...
		%>
  <tr  <%=TrBgColor%> height="20">
    <td>&nbsp;<%=Rs(0)%></td>
    <td>&nbsp;<%=Rs(1)%></td>
    <td>&nbsp;<%=Rs(2)%></td>
    <td>｜<a href="Level_Edit.asp?Level_ID=<%=Rs(0)%>&Page=<%=Page%>" target="tabWin" onclick="fnClick();">修改</a>｜<a href="Level_Del.asp?Level_ID=<%=Rs(0)%>&Page=<%=Page%>">删除</a>｜</td>
  </tr>
	<%
    Rs.MoveNext
