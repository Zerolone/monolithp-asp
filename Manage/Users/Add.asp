...
<form name="form1" method="post" action="<%=ThisPage%>?Code=Add">
	<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
		<tr bgcolor="#6A6A6A" height="26">
			<td colspan="3"><b><font color="#FFFFFF">&nbsp;会员管理 &gt;&gt; 会员资料添加</font></b></td>
		</tr>
		<tr>
			<td width="100" bgcolor="#999999" align="right" height="20">
			<font color="#FFFFFF">标&nbsp;&nbsp;&nbsp; 题：</font></td>
			<td bgcolor="#FFFFFF">
			<input name="Advertisement_Title" type="text" id="Advertisement_Title" size="40" class="InputBox">
			</td>
		</tr>
		<tr>
			...
			<td bgcolor="#FFFFFF">
			<input name="Advertisement_Hits" type="text" id="Advertisement_Hits" value="0" size="40" class="InputBox">
			</td>
		</tr>
		<tr>
			...
			<td bgcolor="#FFFFFF">
			<input name="Advertisement_Width" type="text" id="Advertisement_Width" value="100" size="40" class="InputBox">
			</td>
		</tr>
		<tr>
			<td bgcolor="#999999" align="right" height="20" width="100">
			...
			<td bgcolor="#FFFFFF">
			<input name="Advertisement_Height" type="text" id="Advertisement_Height" value="200" size="40" class="InputBox">
			</td>
		</tr>
		<tr>
			<td bgcolor="#999999" align="right" height="20" width="100">
		...
		<tr>
			...
			<td bgcolor="#FFFFFF">
			<input name="Advertisement_Active" type="radio" value="0" id="Advertisement_Active_0" checked><label for="Advertisement_Active_0">不使用</label>
			<input type="radio" name="Advertisement_Active" value="1" id="Advertisement_Active_1"><label for="Advertisement_Active_1">使用</label>
			</td>
		</tr>
		<tr>
			<td bgcolor="#999999" align="right" height="20" width="100">
		...
		<tr>
			...
			<td bgcolor="#FFFFFF">
			<input name="Advertisement_Url" type="text" id="Advertisement_Url" size="40" class="InputBox">
			</td>
		</tr>
		<tr>
			<td bgcolor="#999999" align="right" height="20" width="100">
			...
			<td bgcolor="#FFFFFF">
			<input name="Advertisement_Color" type="text" id="Advertisement_Color" value="#000000" size="40" class="InputBox">
			</td>
		</tr>
		<tr>
			<td bgcolor="#999999" align="right" height="20" width="100">
		...
		<tr>
			<td bgcolor="#999999" height="20" width="100">　</td>
